...
const ServicesPage = () => {
  ...
  const [modalOpen, setModalOpen] = useState(false); // نافذة تعديل الخدمة
  const [isProcessing, setIsProcessing] = useState(false); // حالة تنفيذ العمليات
  const [newServiceModalOpen, setNewServiceModalOpen] = useState(false); // نافذة إضافة خدمة جديدة
    ...
    <Layout>
      <div style={{ textAlign: "center" }}>
        ...
        {modalOpen && selectedService && (
          ...
          >
            <h2 style={{ marginBottom: "1rem" }}>تعديل الخدمة</h2>
            <Image
  src={supabase.storage
    .from("stor")
  ...
  width={200} // عرض الصورة (يمكنك تعديل القيم حسب الحاجة)
  height={100} // ارتفاع الصورة (يمكنك تعديل القيم حسب الحاجة)
  style={{
    objectFit: "cover",
    borderRadius: "4px",
    marginBottom: "1rem",
...
/>
        ...
        {newServiceModalOpen && (
          ...
          >
            <h2 style={{ marginBottom: "1rem" }}>إضافة خدمة جديدة</h2>
            <form
              onSubmit={(e) => {
                e.preventDefault();
                addNewService();
